...
function dashboard() {
    return ( 
        ...
        <div className="w-full flex justify-between pt-[56px]">
            ...
            <div className="w-[84.5%] pt-10 9xl:px-[245px] 7xl:px-[135px] 5xl:px-[67px] px-5 pb-28 overflow-auto main-content flex flex-col flex-1 left-[280px] dark:bg-[#292929] border-l dark:border-[#474746] border-color-DF h-screen absolute">
